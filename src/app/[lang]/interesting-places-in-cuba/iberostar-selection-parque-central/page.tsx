...
export async function generateMetadata({
  ...
  const metadata = buildMetaTags(
    idioma.metadata.interestingPlaces?.iberostarParqueCentral as any
  );
  return metadata;
}
  ...
  return (
    <PlaceSEOCard
      seo={{
        ...
        canonical:
          "https://cubantaxis.com/interesting-places-in-cuba/iberostar-selection-parque-central",
        robots: "index,follow",
      ...
      place={{
        ...
        description:
          "Hotel colonial y moderno en el centro de La Habana, con vistas al Capitolio. Rooftop con piscina, Capitol Level exclusivo y servicios de conferencias y eventos.",
        address: {
