...
export async function generateMetadata({
  ...
  const metadata = buildMetaTags(
    idioma.metadata.interestingPlaces?.ocioClub as any
  );
  return metadata;
}
  ...
  return (
    <PlaceSEOCard
      seo={{
        ...
        canonical:
          "https://cubantaxis.com/interesting-places-in-cuba/ocio-club",
        robots: "index,follow",
      ...
      place={{
        ...
        description:
          "Centro recreativo en Varadero con juegos electrónicos y mecánicos de última generación, realidad virtual y atracciones para todas las edades. Ideal para familias.",
        address: {
