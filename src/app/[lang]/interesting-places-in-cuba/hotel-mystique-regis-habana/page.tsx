...
export async function generateMetadata({
  ...
  const metadata = buildMetaTags(
    idioma.metadata.interestingPlaces?.hotelMystiqueRegisHavana as any
  );
  return metadata;
}
  ...
  return (
    <PlaceSEOCard
      seo={{
        ...
        canonical:
          "https://cubantaxis.com/interesting-places-in-cuba/hotel-mystique-regis-habana",
        robots: "index,follow",
      ...
      place={{
        ...
        description:
          "Inspirado en el glamour de 1900, este hotel boutique combina elegancia histórica con comodidades modernas. Ubicado en Habana Vieja, cerca de sitios UNESCO.",
        address: {
