...
export async function generateMetadata(
  ...
  const metadata = buildMetaTags(idioma.metadata.interestingPlaces?.hotelMystiqueRegisHavana as any)
  return metadata
}
    ...
    return (
        <PlaceSEOCard
            seo={{
                ...
                canonical: "https://cubantaxis.com/interesting-places-in-cuba/hotel-mystique-regis-habana",
                robots: "index,follow",
