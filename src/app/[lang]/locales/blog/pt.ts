...
export const articles = {
  howMuchIsATaxiInCuba: {
    ...
    hero: {
      ...
      ctaPrimary: { label: "Reservar transfer privado", href: "/taxi" },
    ...
    valueProps: [
      {
        ...
        desc: "Cotações confirmadas para aeroportos e rotas interurbanas. Nada de taxas escondidas.",
      },
      {
        title: "O veículo certo para você",
        desc: "Carros clássicos para passeios na cidade ou minivans confortáveis para famílias.",
      },
      {
        title: "Pick-ups confiáveis",
        desc: "Motoristas que falam inglês e monitoramento de voos para chegadas no aeroporto.",
      },
    ],
    prices: {
      ...
      cta: { label: "Pedir cotação", href: "/taxi" },
    },
    tips: {
      whatAffects: {
      ...
      touristTips: {
        ...
        link: {
          label: "reservar seu táxi online",
  ...
  privateTaxiOrCarRental: {
    seo: {
      headline:
        "Táxi Privado ou Aluguel de Carro — Qual é Melhor para Viajar em Cuba?",
      description:
    ...
    hero: {
      ...
      ctaPrimary: { label: "Reservar táxi privado", href: "/taxi" },
    ...
    sections: {
      privateTaxi: {
        ...
        samplePrices: [
          {
            route: "Havana → Varadero",
            price: "a partir de $100 (carro moderno) / $180 (minivan)",
          },
      ...
      comparison: {
        title:
          "Comparação de Custo & Conforto — Havana ↔ Varadero (Ida e Volta)",
        table: {
          columns: [
            "Opção",
            "Preço Total",
    ...
    prices: {
      ...
      cta: { label: "Solicitar cotação", href: "/taxi" },
    },
    tips: {
      whatAffects: {
        title: "O que influencia o preço?",
    ...
    ctaFooter: {
      ...
      primary: { label: "Reservar traslado", href: "/taxi" },
      secondary: {
        label: "Explorar passeios privados",
