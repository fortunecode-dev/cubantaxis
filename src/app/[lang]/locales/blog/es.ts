...
export const articles = {
  howMuchIsATaxiInCuba: {
    ...
    hero: {
      ...
      ctaPrimary: { label: "Reservar un transfer privado", href: "/taxi" },
    ...
    prices: {
      ...
      cta: { label: "Solicitar cotización", href: "/taxi" },
    },
    tips: {
      whatAffects: {
  ...
  privateTaxiOrCarRental: {
    seo: {
      headline:
        "Taxi privado o alquiler de coche — ¿Qué es mejor para viajar por Cuba?",
      description:
        "Compara taxis privados vs. alquiler de coches en Cuba. Descubre qué opción se adapta a tu estilo de viaje, presupuesto y confort para trayectos desde La Habana, Varadero, Trinidad o Viñales.",
    ...
    ui: {
      heroSizes: "(min-width: 1024px) 900px, 100vw",
      comparisonNote:
        "Todos los precios son por coche (servicio privado). Basado en traslados estándar en vehículos modernos o clásicos. Pueden aplicarse suplementos nocturnos o por larga distancia.",
      ctaAltQuestion:
        "¿Necesitas un traslado privado o quieres combinar ambas opciones en tu itinerario?",
    },
    breadcrumb: {
      homeLabel: "Inicio",
      blogLabel: "Blog",
    ...
    hero: {
      ...
      introP1:
        "¿Dudas entre reservar un taxi privado o alquilar un coche en Cuba? Aquí tienes una guía detallada que compara confort, coste, flexibilidad y conveniencia para rutas como La Habana–Varadero, Viñales y Trinidad.",
      ctaPrimary: { label: "Reservar un taxi privado", href: "/taxi" },
    ...
    valueProps: [
      ...
      {
        title: "El vehículo adecuado para ti",
        desc: "Coches clásicos para tours urbanos o minivans cómodas para familias.",
      },
      {
        title: "Recogidas confiables",
        desc: "Choferes que hablan inglés y monitoreo de vuelos para llegadas al aeropuerto.",
    ...
    sections: {
      privateTaxi: {
        ...
        paragraph1:
          "Un taxi privado en Cuba ofrece el equilibrio perfecto entre confort, fiabilidad y conocimiento local. Es ideal si quieres disfrutar del viaje sin preocuparte por la navegación o las condiciones de las carreteras.",
        advantages: [
        ...
        samplePrices: [
          {
            route: "La Habana → Varadero",
            price: "desde $100 (coche moderno) / $180 (minivan)",
          },
          { route: "La Habana → Viñales", price: "$180–$200" },
          {
            route: "La Habana → Cayo Santa María",
            price: "$350 (coche privado)",
          },
        ],
        bestFor:
          "Parejas, familias o viajeros que buscan una experiencia relajada con servicio puerta a puerta confiable.",
      },
      carRental: {
        title: "Alquiler de coche: la libertad trae responsabilidad",
        paragraph1:
          "Alquilar un coche en Cuba ofrece independencia total para explorar a tu ritmo. Sin embargo, requiere preparación y tolerancia ante los retos viales de la isla.",
        pros: [
        ...
        estimatedCosts:
          "Los coches de alquiler en Cuba suelen costar $70–$120 por día, más seguro y combustible. Un viaje de 5 días puede superar los $500, similar a contratar un conductor privado.",
      },
      comparison: {
        title:
          "Comparativa de coste y confort — Ida y vuelta La Habana ↔ Varadero",
        table: {
          columns: [
            "Opción",
            "Precio total",
        ...
        verdict:
          "Para la mayoría de visitantes, los taxis privados ofrecen mejor relación calidad-precio y tranquilidad. Los alquileres convienen a quienes priorizan independencia sobre conveniencia.",
      },
      hybridOption: {
        title: "Tours en taxi privado — Lo mejor de ambos mundos",
        paragraph:
          "Si quieres explorar sin conducir, los tours en taxi privado son un híbrido perfecto. Obtienes libertad y flexibilidad con el confort de un chofer local.",
        examples: [
      ...
      conclusion: {
        ...
        paragraph1:
          "Tanto los taxis privados como los alquileres tienen sus ventajas. La elección correcta depende de tu personalidad viajera y tus objetivos.",
        bulletSummary: [
        ...
        closingNote:
          "Cualquiera que elijas, cada carretera cubana cuenta una historia — desde los convertibles antiguos de La Habana hasta los tranquilos valles de Viñales.",
      },
    },
    prices: {
      title: "Precios de taxis en Cuba por ruta (2025)",
      intro:
        "Los precios son por coche (servicio privado). La cotización final depende del tipo de coche (clásico/moderno o minivan), punto de recogida, suplementos nocturnos y paradas opcionales.",
      columns: {
        route: "Ruta",
        classicModern: "Clásico / Moderno",
        minivan: "Minivan",
      ...
      rows: [
        {
          route: "Aeropuerto de La Habana (HAV) → Centro",
          classicModern: "$30",
          minivan: "$55",
          notes: "Traslado típico de llegada",
        },
        {
          route: "La Habana → Varadero",
          classicModern: "$100",
          minivan: "$180",
          notes: "Retorno el mismo día disponible",
        },
        {
          route: "La Habana → Viñales",
          classicModern: "$130",
          minivan: "$200",
          notes: "Ida y vuelta a solicitud",
        },
        {
          route: "La Habana → Trinidad",
          classicModern: "$250",
          minivan: "$320",
          notes: "Vía Cienfuegos opcional",
        },
        {
        ...
        {
          route: "Aeropuerto de Varadero (VRA) → Hoteles",
          classicModern: "$40",
          minivan: "$70",
          notes: "",
        },
      ...
      footnote:
        "Los precios pueden variar para recogidas lejos del KM-0 de La Habana (Capitolio) y para horas nocturnas.",
      cta: { label: "Solicitar presupuesto", href: "/taxi" },
    },
    tips: {
      whatAffects: {
      ...
      touristTips: {
        title: "Consejos para turistas",
        paragraphPrefix:
          "Reserva con antelación para fijar la tarifa y comparte tu número de vuelo para recogidas en el aeropuerto. Los traslados privados son la opción más conveniente y segura. Puedes",
        link: {
          label: "reservar tu taxi online",
          href: "/private-transfer-booking",
        },
    ...
    ctaFooter: {
      ...
      primary: { label: "Reservar un traslado", href: "/taxi" },
      secondary: {
        label: "Explorar tours privados",
