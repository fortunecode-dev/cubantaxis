...
export const articles = {
  howMuchIsATaxiInCuba: {
    ...
    hero: {
      ...
      ctaPrimary: { label: "Book a private transfer", href: "/taxi" },
    ...
    prices: {
      ...
      cta: { label: "Get a quote", href: "/taxi" },
    },
    tips: {
      whatAffects: {
  ...
  privateTaxiOrCarRental: {
    seo: {
      headline:
        "Private Taxi or Car Rental — What’s Better for Traveling in Cuba?",
      description:
    ...
    hero: {
      ...
      ctaPrimary: { label: "Book a private taxi", href: "/taxi" },
        ...
        samplePrices: [
          {
            ...
            price: "from $100 (modern car) / $180 (minivan)",
          },
    ...
    ctaFooter: {
      ...
      primary: { label: "Book a transfer", href: "/taxi" },
      secondary: {
