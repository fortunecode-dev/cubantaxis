...
export const articles = {
  howMuchIsATaxiInCuba: {
    ...
    hero: {
      ...
      ctaPrimary: { label: "Réserver un transfert privé", href: "/taxi" },
    ...
    valueProps: [
      {
        ...
        desc: "Devis confirmés pour aéroports et trajets interurbains. Pas de frais cachés.",
      },
      {
        title: "Le bon véhicule pour vous",
        desc: "Voitures classiques pour les visites ou minivans confortables pour les familles.",
      },
      {
        title: "Prises en charge fiables",
        desc: "Chauffeurs anglophones et suivi des vols pour les arrivées.",
      },
    ],
    prices: {
      ...
      columns: {
        route: "Trajet",
        classicModern: "Classique / Moderne",
        minivan: "Minivan",
        notes: "Notes",
      },
      ...
      cta: { label: "Demander un devis", href: "/taxi" },
    },
    tips: {
      whatAffects: {
      ...
      touristTips: {
        ...
        link: {
          label: "réserver votre taxi en ligne",
  ...
  privateTaxiOrCarRental: {
    seo: {
      headline:
        "Taxi privé ou location de voiture — Que choisir pour voyager à Cuba ?",
      description:
        "Comparez les taxis privés et la location de voitures à Cuba. Découvrez quelle option convient à votre style de voyage, budget et confort pour des trajets depuis La Havane, Varadero, Trinidad ou Viñales.",
    ...
    ui: {
      heroSizes: "(min-width: 1024px) 900px, 100vw",
      comparisonNote:
        "Tous les prix sont par voiture (service privé). Basés sur des transferts standards en véhicules modernes ou classiques. Des suppléments de nuit ou longue distance peuvent s'appliquer.",
      ctaAltQuestion:
        "Besoin d'un transfert privé ou souhaitez-vous combiner les deux options dans votre itinéraire ?",
    },
    breadcrumb: {
      homeLabel: "Accueil",
      blogLabel: "Blog",
    ...
    hero: {
      ...
      introP1:
        "Vous hésitez entre réserver un taxi privé ou louer une voiture à Cuba ? Voici un guide détaillé comparant confort, coût, flexibilité et commodité pour des trajets comme La Havane–Varadero, Viñales et Trinidad.",
      ctaPrimary: { label: "Réserver un taxi privé", href: "/taxi" },
      ctaSecondary: {
        label: "Voir les prix par itinéraire",
        href: "#comparison",
      },
    ...
    valueProps: [
      {
        title: "Tarification transparente",
        desc: "Devis confirmés pour aéroports et trajets interurbains. Aucuns frais cachés.",
      },
      {
        title: "Véhicule adapté",
        desc: "Voitures classiques pour les visites urbaines ou minivans confortables pour les familles.",
      },
      {
        title: "Prises en charge fiables",
        desc: "Chauffeurs anglophones et suivi des vols pour les arrivées à l'aéroport.",
      },
    ],
    sections: {
      privateTaxi: {
        ...
        paragraph1:
          "Un taxi privé à Cuba offre le parfait équilibre entre confort, fiabilité et expertise locale. Idéal si vous souhaitez profiter du voyage sans vous soucier de la navigation ou de l'état des routes.",
        advantages: [
        ...
        samplePrices: [
          {
            route: "La Havane → Varadero",
            price: "à partir de $100 (voiture moderne) / $180 (minivan)",
          },
          { route: "La Havane → Viñales", price: "$180–$200" },
          {
            route: "La Havane → Cayo Santa María",
            price: "$350 (voiture privée)",
          },
        ],
        bestFor:
          "Couples, familles ou voyageurs cherchant une expérience détendue avec un service porte-à-porte fiable.",
      },
      carRental: {
        title: "Location de voiture : la liberté implique des responsabilités",
        paragraph1:
          "Louer une voiture à Cuba offre une indépendance totale pour explorer à votre rythme. Cependant, cela nécessite préparation et tolérance face aux défis routiers de l'île.",
        pros: [
        ...
        estimatedCosts:
          "Les voitures de location à Cuba coûtent généralement $70–$120 par jour, plus l'assurance et le carburant. Un séjour de 5 jours peut dépasser $500, similaire à l'embauche d'un chauffeur privé.",
      },
      comparison: {
        title:
          "Comparaison coûts & confort — Aller-retour La Havane ↔ Varadero",
        table: {
        ...
        verdict:
          "Pour la plupart des visiteurs, les taxis privés offrent un meilleur rapport qualité-prix et la tranquillité d'esprit. Les locations conviennent à ceux qui privilégient l'indépendance.",
      },
      hybridOption: {
        title: "Tours en taxi privé — Le meilleur des deux mondes",
        paragraph:
          "Si vous voulez explorer sans conduire, les tours en taxi privé sont un hybride parfait. Vous gagnez en liberté et flexibilité avec le confort d'un chauffeur local.",
        examples: [
      ...
      conclusion: {
        ...
        paragraph1:
          "Taxis privés et locations ont leurs mérites. Le bon choix dépend de votre personnalité de voyageur et de vos objectifs.",
        bulletSummary: [
        ...
        closingNote:
          "Quel que soit votre choix, chaque route cubaine raconte une histoire — des convertibles rétro de La Havane aux paisibles vallées de Viñales.",
      },
    },
    prices: {
      title: "Tarifs des taxis à Cuba par trajet (2025)",
      intro:
        "Les prix sont par voiture (service privé). Le devis final dépend du type de véhicule (classique/moderne ou minivan), du point de prise en charge, des suppléments nocturnes et des arrêts optionnels.",
      columns: {
        route: "Trajet",
        classicModern: "Classique / Moderne",
        minivan: "Minivan",
      ...
      rows: [
        {
          route: "Aéroport de La Havane (HAV) → Centre-ville",
          classicModern: "$30",
          minivan: "$55",
          notes: "Transfert typique d'arrivée",
        },
        {
          route: "La Havane → Varadero",
          classicModern: "$100",
          minivan: "$180",
          notes: "Retour le même jour possible",
        },
        {
          route: "La Havane → Viñales",
          classicModern: "$130",
          minivan: "$200",
          notes: "Aller-retour sur demande",
        },
        {
          route: "La Havane → Trinidad",
          classicModern: "$250",
          minivan: "$320",
          notes: "Via Cienfuegos optionnel",
        },
        {
          route: "Varadero → Cienfuegos",
          classicModern: "$120",
          minivan: "$205",
          notes: "",
        },
        {
          route: "Varadero → Trinidad",
          classicModern: "$250",
          minivan: "$270",
          notes: "",
        },
        {
          route: "Aéroport de Varadero (VRA) → Hôtels",
          classicModern: "$40",
          minivan: "$70",
          notes: "",
        },
      ...
      footnote:
        "Les prix peuvent varier pour les prises en charge loin du KM-0 de La Havane (Capitolio) et pour les heures nocturnes.",
      cta: { label: "Obtenir un devis", href: "/taxi" },
    },
    tips: {
      whatAffects: {
        title: "Ce qui influence le prix",
      ...
      touristTips: {
        ...
        paragraphPrefix:
          "Réservez à l'avance pour fixer un tarif et partagez votre numéro de vol pour les prises en charge à l'aéroport. Les transferts privés sont l'option la plus pratique et sûre. Vous pouvez",
        link: {
          label: "réserver votre taxi en ligne",
          href: "/private-transfer-booking",
        },
    ...
    ctaFooter: {
      ...
      primary: { label: "Réserver un transfert", href: "/taxi" },
      secondary: {
        label: "Explorer les tours privés",
