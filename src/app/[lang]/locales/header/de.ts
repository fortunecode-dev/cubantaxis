    ...
    items: [
      {
        ...
        href: `/de/interesting-places-in-cuba/gran-hotel-manzana-kempinski`,
      },
      {
        title: "Hotel Mystique Regis Havanna",
        href: `/de/interesting-places-in-cuba/hotel-mystique-regis-habana`,
      },
      {
        title: "Iberostar Selection Parque Central",
        href: `/de/interesting-places-in-cuba/iberostar-selection-parque-central`,
      },
      {
        title: "Melia Internacional Varadero",
        href: `/de/interesting-places-in-cuba/melia-internacional-varadero`,
      },
      {
        title: "Melia Las Americas",
        href: `/de/interesting-places-in-cuba/melia-las-americas`,
      },
      { title: "Ocio Club", href: `/de/interesting-places-in-cuba/ocio-club` },
    ],
    allHref: `/de/interesting-places-in-cuba`,
