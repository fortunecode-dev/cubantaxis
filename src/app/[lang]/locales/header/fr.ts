...
export const header: HeaderItems = [
  ...
  {
    key: "places",
    label: "Lieux intéressants",
    items: [
      {
        title: "Gran Hotel Manzana Kempinski",
        href: `/fr/interesting-places-in-cuba/gran-hotel-manzana-kempinski`,
      },
      {
        title: "Hotel Mystique Regis La Havane",
        href: `/fr/interesting-places-in-cuba/hotel-mystique-regis-habana`,
      },
      {
        title: "Iberostar Selection Parque Central",
        href: `/fr/interesting-places-in-cuba/iberostar-selection-parque-central`,
      },
      {
        title: "Meliá Internacional Varadero",
        href: `/fr/interesting-places-in-cuba/melia-internacional-varadero`,
      },
      {
        title: "Meliá Las Américas",
        href: `/fr/interesting-places-in-cuba/melia-las-americas`,
      },
      { title: "Ocio Club", href: `/fr/interesting-places-in-cuba/ocio-club` },
    ],
    allHref: `/fr/interesting-places-in-cuba`,
    allLabel: "Voir tout",
  },
  {
    key: "destinations",
