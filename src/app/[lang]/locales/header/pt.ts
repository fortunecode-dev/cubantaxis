...
export const header: HeaderItems = [
  ...
  {
    key: "places",
    label: "Lugares interessantes",
    items: [
      {
        title: "Gran Hotel Manzana Kempinski",
        href: `/pt/interesting-places-in-cuba/gran-hotel-manzana-kempinski`,
      },
      {
        title: "Hotel Mystique Regis Havana",
        href: `/pt/interesting-places-in-cuba/hotel-mystique-regis-habana`,
      },
      {
        title: "Iberostar Selection Parque Central",
        href: `/pt/interesting-places-in-cuba/iberostar-selection-parque-central`,
      },
      {
        title: "Meliá Internacional Varadero",
        href: `/pt/interesting-places-in-cuba/melia-internacional-varadero`,
      },
      {
        title: "Meliá Las Américas",
        href: `/pt/interesting-places-in-cuba/melia-las-americas`,
      },
      { title: "Ocio Club", href: `/pt/interesting-places-in-cuba/ocio-club` },
    ],
    allHref: `/pt/interesting-places-in-cuba`,
    allLabel: "Ver todos",
  },
  {
    key: "destinations",
