...
export const metadata: Partial<customMetaData> = {
  ...
  blog: {
    ...
    howMuchIsATaxiInCuba: {
      title: "Preços de Táxi em Cuba 2025 | Transfers & Reserva de Passeio",
      description:
    ...
    privateTaxiOrCarRental: {
      title: "Preços de táxi em Cuba 2025 | Viagens e traslados",
      description:
        "Veja tarifas 2025 de táxis em Cuba. Compare rotas, transfers e passeios de Havana, Varadero e outras cidades com CubanTaxis.",
      alternates: buildAlternatesMetadata(
  ...
  fastBooking: {
    ...
    alternates: buildAlternatesMetadata("/taxi", "pt"),
  },
