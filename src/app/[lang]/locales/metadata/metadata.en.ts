...
export const metadata: Partial<customMetaData> = {
    landingPage: {
        ...
        description: "Book Cuba taxi transfers and tours online. Fixed prices, fast booking, English-speaking drivers in Havana and Varadero with CubanTaxis.",
  ...
  alternates: buildAlternatesMetadata(
    ...
    taxiInCuba: {
        ...
        description: "Discover Cuba in 2025 with CubanTaxis. Your trusted partner for taxi transfers, tours and booking in Havana, Varadero and across the island.",
    ...
    interestingPlaces: {
        self: {
            ...
            description: "CubanTaxis takes you to the best hotels and places of interest in Cuba. Book taxi transfers, tours and stays in Havana and Varadero.",
            alternates: buildAlternatesMetadata(
