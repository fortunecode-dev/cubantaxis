...
export const metadata: Partial<customMetaData> = {
  ...
  blog: {
    ...
    howMuchIsATaxiInCuba: {
      title: "Цены на Такси на Кубе 2025 | Трансферы и Бронирование Туров ",
      description:
    ...
    privateTaxiOrCarRental: {
      ...
      description:
        "Узнайте цены на такси 2025 года. Сравните маршруты, трансферы и экскурсии из Гаваны, Варадеро и других городов с CubanTaxis.",
      alternates: buildAlternatesMetadata(
  ...
  fastBooking: {
    ...
    alternates: buildAlternatesMetadata("/taxi", "ru"),
  },
