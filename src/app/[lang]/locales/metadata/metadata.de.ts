...
export const metadata: Partial<customMetaData> = {
  landingPage: {
    ...
    description: "Buchen Sie Taxi-Transfers und Touren in Kuba online. Festpreise, schnelle Buchung, englischsprachige Fahrer in Havanna & Varadero mit CubanTaxis.",
  ...
  description: "Erfahren Sie 2025 Taxipreise in Kuba. Vergleichen Sie Fahrten, Transfers und Touren ab Havanna, Varadero und mehr mit CubanTaxis.",
  ...
  taxiInCuba: {
    ...
    description: "Entdecken Sie Kuba 2025 mit CubanTaxis: Ihr Partner für Taxis, Transfers, Touren und Buchung in Havanna, Varadero und auf der ganzen Insel.",
  ...
  interestingPlaces: {
    self: {
      ...
      description: "CubanTaxis bringt Sie zu den besten Hotels und Sehenswürdigkeiten Kubas. Buchen Sie Taxi-Transfers, Touren und Aufenthalte in Havanna & Varadero.",
    ...
    meliaLasAmericas: {
      ...
      description: "Planen Sie mit CubanTaxis Ihren Besuch im Meliá Las Américas Varadero. Taxi-Transfers, Touren und Hotelbuchung auf einen Klick.",
