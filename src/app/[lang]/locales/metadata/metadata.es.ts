...
export const metadata: Partial<customMetaData> = {
  ...
  blog: {
    ...
    privateTaxiOrCarRental: {
      ...
      description:
        "Consulta tarifas 2025 de taxis en Cuba. Compara traslados, excursiones y rutas desde La Habana, Varadero y más con CubanTaxis.",
    ...
    howMuchIsATaxiInCuba: {
      title: "Precios de Taxi en Cuba 2025 | Traslados y Reserva de Tours ",
      description:
  ...
  fastBooking: {
    ...
    alternates: buildAlternatesMetadata("/taxi", "es"),
  },
