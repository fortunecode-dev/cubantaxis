export const content = {
  hero: {
    h1Title: "Réservez un Taxi à Cuba — Rapide, Sûr et Fiable",
    h2SubTitle:
      "Réservez instantanément : transferts aéroport, visites de ville et taxis interurbains partout à Cuba",
    introParagraph:
      "Vous voyagez à Cuba ? Réservez votre taxi privé ou partagé en quelques minutes—sans surprises ni tracas. Que vous atterrissiez à l’aéroport de La Havane, exploriez Varadero ou alliez à Trinidad ou Viñales, on rend votre trajet simple et serein.",
    list: {
      id: "available-services",
      h2: "Services disponibles :",
      items: [
        "Transferts privés dans toute Cuba",
        "Taxis d’aéroport (La Havane, Varadero, etc.)",
        "Réservations express de dernière minute",
        "Visites classiques de La Havane",
        "Excursions depuis Varadero",
        "Taxis partagés pour économiser",
        "Trajets vers les Plages de l’Est",
        "Guides touristiques agréés",
      ],
    },
    link: {
      label: "En savoir plus sur les taxis à Cuba",
      href: "/fr/taxi-in-cuba",
    },
    cta: {
      customBooking: "Réservez votre trajet à l’avance",
      fastBooking: "Réservation rapide",
      customBookingHref: "/fr/private-transfer-booking",
      fastBookingHref: "/fr/taxi",
    },
  ...
  blog: {
    ...
    listActions: [{ label: "Réserver", href: "/taxi" }],
