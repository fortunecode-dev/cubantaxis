...
const DESTINATIONS: Destination[] = [
  {
    ...
    long: "Havana is the capital and cultural heart of Cuba. From Old Havana’s UNESCO-listed streets to the oceanfront Malecón, visitors enjoy colonial plazas, live music, iconic bars like El Floridita and La Bodeguita, and panoramic views from El Morro fortress. Airport code: HAV (José Martí International).",
  ...
  },
  {
    ...
    long: "Varadero offers 20+ km of fine white sand and calm, turquoise waters. It’s ideal for families and couples who want resorts, watersports, golf, and easy day trips to Cárdenas, Cayo Blanco or Matanzas. Airport code: VRA (Juan Gualberto Gómez International).",
    tags: ["Beach", "Resorts"],
  },
  {
    slug: "vinales",
    ...
    long: "Viñales Valley is famous for its limestone mogotes, tobacco plantations, horseback rides, and caves like Cueva del Indio. A perfect day trip or overnight from Havana for nature lovers and photographers.",
    tags: ["Nature", "Tobacco"],
  },
  {
    slug: "trinidad",
    ...
    long: "One of Cuba’s best-preserved colonial towns. Explore Plaza Mayor, craft markets, live music houses, and nearby attractions like Playa Ancón and the Valle de los Ingenios.",
  ...
  },
  {
    ...
    long: "Cienfuegos mixes French-influenced architecture with a laid-back bayfront vibe. Don’t miss Parque José Martí, the Palacio de Valle, and the Punta Gorda promenade.",
    tags: ["Bay", "Architecture"],
  },
  {
    slug: "santa-clara",
    title: "Santa Clara",
    image: "/landmarks-vinales-trinidad.webp",
    alt: "Che Guevara Mausoleum in Santa Clara",
    short: "Historic city with the Che Guevara Mausoleum.",
    long: "Santa Clara is known for the Che Guevara Mausoleum and key events of the Cuban Revolution. It’s also a strategic hub for trips to the northern keys.",
    tags: ["History", "Hub"],
  },
  {
    ...
    long: "A chain of beaches 20–30 minutes from central Havana (e.g., Santa María del Mar). Perfect for quick sun-and-sea escapes without leaving the city long.",
  ...
  },
  {
    ...
    long: "Part of Cuba’s Jardines del Rey archipelago, Cayo Coco features white-sand beaches, excellent snorkeling, and quiet resort life. Popular for honeymoons and families.",
    tags: ["Keys", "Resorts"],
  },
  {
    slug: "cayo-guillermo",
    ...
    long: "Neighbor to Cayo Coco, this key is known for Playa Pilar, towering dunes, and kitesurf spots. Calm waters and postcard views everywhere.",
  ...
  },
  {
    ...
    long: "Linked by a scenic causeway from the mainland, Cayo Santa María offers tranquil beaches, spa resorts, and easy access to Remedios and Santa Clara.",
    tags: ["Keys", "Relax"],
  },
  {
    ...
    long: "Juan Gualberto Gómez International (VRA) serves Varadero’s hotel strip and nearby towns. We offer private transfers to any hotel, day or night.",
    tags: ["Airport", "Transfers"],
  },
  {
    slug: "havana-airport",
    title: "Havana Airport (HAV / José Martí)",
    image: "/havana-capitol.avif",
    alt: "Classic car near Havana Capitol building",
    short: "Main international gateway to Cuba.",
    long: "José Martí International (HAV) is Cuba’s busiest airport. We provide reliable pickups to Havana Centro, Vedado, Miramar, and beyond (Varadero, Viñales, Trinidad).",
    tags: ["Airport", "Transfers"],
  },
];
      ...
      <main className="relative bg-white">
        ...
        <header className="mx-auto max-w-6xl px-4 pb-4 pt-3">
          ...
          <p className="mt-4 max-w-3xl text-base leading-7 text-primary">
            ...
            <strong className="text-accent font-bold">
              Viñales, Trinidad, Cienfuegos, Santa Clara
            </strong>{" "}
            and the northern cays. Photos, highlights, and a quick way to{" "}
            <Link
              href={`${lang == "en" ? "" : `/${lang}`}/taxi`}
              prefetch={false}
