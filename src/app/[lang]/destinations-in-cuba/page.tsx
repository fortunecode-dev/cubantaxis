...
const DESTINATIONS: Destination[] = [
  ...
  { slug: "vinales", title: "Viñales", image: "/vinales.avif", alt: "Viñales Valley mogotes and tobacco fields", short: "Mogotes, tobacco farms, caves, and rural life.", long: "Viñales Valley is famous for its limestone mogotes, tobacco plantations, horseback rides, and caves like Cueva del Indio. A perfect day trip or overnight from Havana for nature lovers and photographers.", tags: ["Nature", "Tobacco"] },
  ...
  { slug: "hav-airport", title: "Havana Airport (HAV / José Martí)", image: "/havana-capitol.avif", alt: "Classic car near Havana Capitol building", short: "Main international gateway to Cuba.", long: "José Martí International (HAV) is Cuba’s busiest airport. We provide reliable pickups to Havana Centro, Vedado, Miramar, and beyond (Varadero, Viñales, Trinidad).", tags: ["Airport", "Transfers"] },
];
