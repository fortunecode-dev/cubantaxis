    ...
    <main className="relative">
      ...
      <Script id="ld-breadcrumb" type="application/ld+json" strategy="afterInteractive">
        {JSON.stringify({
          ...
          "@type": "BreadcrumbList",
          itemListElement: [
            { "@type": "ListItem", position: 1, name: t(lang, "Home", "Inicio"), item: `https://cubantaxis.com/${lang=="en"?"":`/${lang}`}` },
            { "@type": "ListItem", position: 2, name: t(lang, "Taxi in Cuba", "Taxi en Cuba"), item: `https://cubantaxis.com${lang=="en"?"":`/${lang}`}/taxi-in-cuba` },
          ],
        })}
      </Script>
      ...
      <Script id="ld-service" type="application/ld+json" strategy="afterInteractive">
        {JSON.stringify({
          ...
          name: "CubanTaxis",
          areaServed: "Cuba",
          url: `https://cubantaxis.com/${lang=="en"?"":`/${lang}`}/taxi-in-cuba`,
