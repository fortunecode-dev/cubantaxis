...
const rows = [
  {
    routeEn: "Havana → Varadero",
    routeEs: "La Habana → Varadero",
    price: "US$ 95",
  },
  {
    routeEn: "Havana → Viñales",
    routeEs: "La Habana → Viñales",
    price: "US$ 100",
  },
  {
    routeEn: "Havana → Trinidad",
    routeEs: "La Habana → Trinidad",
    price: "US$ 180",
  },
  {
    routeEn: "HAV Airport → Havana",
    routeEs: "Aeropuerto HAV → La Habana",
    price: "US$ 25",
  },
];
